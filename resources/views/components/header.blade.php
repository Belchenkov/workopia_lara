    ...
    <div class="container mx-auto flex justify-between items-center">
        ...
        <nav class="hidden md:flex items-center space-x-4">
            <a
                ...
                class="text-white hover:underline py-2 {{ request()->is('jobs') ? 'text-yellow-400 font-bold' : '' }}"
            >All Jobs</a
            >
            <a
                href="{{route('home.index')}}"
                class="text-white hover:underline py-2 {{ request()->is('jobs/saved') ? 'text-yellow-400 font-bold' : '' }}"
            >Saved Jobs</a
            >
            <a
                href="{{route('home.index')}}"
                class="text-white hover:underline py-2 {{ request()->is('login') ? 'text-yellow-400 font-bold' : '' }}"
            >Login</a
            >
            <a
                href="{{route('home.index')}}"
                class="text-white hover:underline py-2 {{ request()->is('register') ? 'text-yellow-400 font-bold' : '' }}"
            >Register</a
            >
            <a
                href="{{route('home.index')}}"
